...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/muzik$1.0.0/src/app/views/base/login/login.marko",
...
marko_template.meta = {
    id: "/muzik$1.0.0/src/app/views/base/login/login.marko",
    tags: [
